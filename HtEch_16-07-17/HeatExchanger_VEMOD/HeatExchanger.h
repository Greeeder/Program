...
public:
	...
	struct stInputs{					//|< linear nodes data (geometri, etc.)
		int HeatExchanger_ID;			//!< ID of heat exchanger
		double Temperature_inlet_1;		//!< Temperature of the first fluid at the inlet of the heat exchanger
		double Temperature_inlet_2;		//!< Temperature of the second fluid at the inlet of the heat exchanger
		double mass_flow_1;				//!< Mass flow of the first fluid
		double mass_flow_2;				//!< Mass flow of the second fluid
	};

	std::vector<stInputs> inputs;
	...
	*/
	...
	void create_HeatExchangers(int n);
