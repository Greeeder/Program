...
public:
	...
	struct stInputs{				//|< Inputs to the model
	...
	std::vector<stInputs> inputs;	//|< Inputs vector


	struct stResults {				//!< Results structure
		int HeatExchanger_ID;			//!< ID of heat exchanger
	...
	std::vector<stResults> results;	//!< Results vector
...
private:
	...
	int n;	//!< number of heat exchangers


	struct stHeatExchanger {			//!< Heat exchanger properties
	...
	std::vector<stHeatExchanger>HeatExchangers; // Vector of heat exchanger properties
