 ...
 */
#ifndef SOURCE_1DPIPES_TPipeIntHeatExhaust_H_
#define SOURCE_1DPIPES_TPipeIntHeatExhaust_H_

#include "TPipeIntHeat.h"

class TPipeIntHeatExhaust: public TPipeIntHeat {

  public:

	/*!
	 * \fn	TIntakePortIntHeat(double HeatMult);
	 *
	...
	TPipeIntHeatExhaust(int ncells, double HeatMult, VectorXd D, double cellsize);
