...
class TCCCompresor: public TCondicionContorno {
  ...
  public:
	...
	void ReadCompressorDataXML(TCompresor **Compressor, xml_node node_comp, double AmbientTemperature,
							   double AmbientPressure);

	void AsignData(TDeposito **Plenum, int NumberOfPipes, TTubo **Pipe, TCondicionContorno **BC, int numCC,
				   double *AtmosphericComposition, TCompresor **Compressor, double AmbientTemperature,
				   double AmbientPressure);
};
