...
void TLumbrera::LeeDatosInicialesXML(xml_node node_valve, int norden, bool HayMotor, TBloqueMotor *Engine) {
	try {
		...
		int j = 0;
		for(xml_node node_flowc = GetNodeChild(node_2sport, "P2s_FlowCoef"); node_flowc;
