...
//---------------------------------------------------------------------------
	...
	double Ftmax;                     // temperatura maxima transitorio termico
	double Ftmin;   // temperatura por debajo de la cual se considera "lowTcoef"
	double FlowTcoef;
	...
	bool FTranstermico; // Variable to decide if corrector heat transfer coeffiecient must be modified as a function of gas temperature
//---------------------------------------------------------------------------
//          FUNCIONES PRIVADAS
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
	...
	void LeeResultadosMediosCanalDPF(int NumResMedios, const char *FileWAM, fpos_t &filepos);
	...
	void LeeResultadosInstantaneosCanalDPF(int NumResInstantaneos, const char *FileWAM, fpos_t &filepos);
	...
	inline int GetNumeroDeposito() {
		return FNumeroDeposito;
	}
	;
	inline double GetDiametro(int i) {
		return FDiametroTubo[i];
	}
	;
	inline double GetFraccionMasicaInicial(int i) {
		return FComposicionInicial[i];
	}
	;
	inline double GetFraccionMasicaCC(int j, int i) {
		return FFraccionMasicaCC[j][i];
	}
	;
	inline double GetViscosidadDinamica(int i) {
	...
	;
	inline double getNodoIzq() {
		return FNodoIzq;
	}
	;
	inline double getNodoDer() {
		return FNodoDer;
	}
	;
	inline void putTime1(double valor) {
		FTime1 = valor;
	}
	;
	inline double getTime0() {
		return FTime0;
	}
	inline void putTime0(double valor) {
		FTime0 = valor;
	}
	;
	...
	inline void putDeltaTime(double valor) {
		FDeltaTime = valor;
	}
	;
	inline int getNin() {
	...
	;
	inline double getXRef() {
		return FXref;
	}
	;
	inline double getLongitudTotal() {
		return FLongitudTotal;
	}
	;
	inline nmTipoTransCal getTipoTransCal() {
		return FTipoTransCal;
	}
	;
	inline double getCoefAjustFric() {
		return FCoefAjusFric;
	}
	;
	inline int getNumeroCanales() {
		return FNumeroParesdeCanales;
	}
	;
	inline double getMallado() {
		return FMallado;
	}
	;

	inline double GetDensidad(int i) {
		return Frho[i];
	}
	inline double GetArea(int i) {
		return FArea[i];
	}
	inline double GetVelocidad(int i) {
		return FVelocidad0[i];
	}
	;
	inline double GetAsonido(int i) {
		return FAsonido0[i];
	}
	;
	inline double GetPresion(int i) {
		return FPresion0[i];
	}
	;
	inline double GetCoefTurbulencia(int i) {
		return FCoefTurbulencia[i];
	}
	;
	inline double getTemperaturaInicial() {
		return FTini;
	}
	;
	inline double getPresionInicial() {
		return FPini;
	}
	;
	inline double getVelocidadMedia() {
		return FVelMedia;
	}
	;
	inline double GetYespecie(int j, int i) {
		return FFraccionMasicaEspecie[j][i];
	}
	;
	inline double GetYespecieCC(int j, int i) {
		return FFraccionMasicaCC[j][i];
	}
	;
	inline double GetVelocidadCC(int i) {
		return FVelocidadCC[i];
	}
	;
	inline double GetDensidadCC(int i) {
		return FDensidadCC[i];
	}
	;
	inline double GetAreaCC(int i) {
		return FAreaCC[i];
	}
	;
	...
	;
	inline double GetRMezcla(int i) {
		return FRMezcla[i];
	}
	;
	inline double GetCp(int i) {
		return FCpMezcla[i];
	}
	;
	inline double GetCv(int i) {
		return FCvMezcla[i];
	}
	;
	inline int getNumeroEspecies() {
		return FNumeroEspecies;
	}
	;
	inline double Geth(int i) {
		return Fhi[i];
	}
	;
	inline double Gethext(int i) {
		return Fhe[i];
	}
	;
	inline double GetH0Pared(int i) {
		return FH0Pared[i];
	}
	;

	inline nmFormulacionLeyes getFormulacionLeyes() {
		return FMod.FormulacionLeyes;
	}
	;
	inline double GetU0(int i, int j) {
		return FU0[i][j];
	}
	;
	inline int getNodoInicialFuente() {
		return FNodoInicialFuente;
	}
	;
	inline int getNodoFinalFuente() {
		return FNodoFinalFuente;
	}
	;
	inline double getDistanciaInterpolacion() {
		return FDistanciaInterpolacion;
	}
	;
	inline double GetLadoCanal(int i) {
		return FLadoCanal[i];
	}
	;
