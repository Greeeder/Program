	...
	try {
		...
		if(FNumVarMed > 0) {
			if(FResMediosCilindro.TrabajoNeto) {
				Label = "\t" + PutLabel(5001) + "/" + std::to_string(FNumeroCilindro) + "/" + PutLabel(4021) + PutLabel(
							907) + "/" + PutLabel(3001);
				medoutput << Label.c_str();
			}
			if(FResMediosCilindro.PresionMediaNeta) {
				Label = "\t" + PutLabel(5001) + "/" + std::to_string(FNumeroCilindro) + "/" + PutLabel(4006) + PutLabel(
							908) + "/" + PutLabel(3002);
				medoutput << Label.c_str();
			}
			...
			if(FResMediosCilindro.CalorCombustion) {
				Label = "\t" + PutLabel(5001) + "/" + std::to_string(FNumeroCilindro) + "/" + PutLabel(4010) + PutLabel(
							907) + "/" + PutLabel(3005);
				medoutput << Label.c_str();
			}
			...
			if(FResMediosCilindro.MasaAtrapada) {
				Label = "\t" + PutLabel(5001) + "/" + std::to_string(FNumeroCilindro) + "/" + PutLabel(4004) + PutLabel(
							913) + "/" + PutLabel(3010);
				medoutput << Label.c_str();
			}
			if(FResMediosCilindro.TemperaturaCilindroInterna) {
				Label = "\t" + PutLabel(5001) + "/" + std::to_string(FNumeroCilindro) + "/" + PutLabel(4005) + PutLabel(
			...
			if(FResMediosCilindro.NITMedio) {
				for(int i = 0; i < FNumeroUnionesEsc; i++) {
					Label = "\t" + PutLabel(5001) + "/" + std::to_string(FNumeroCilindro) + "/" + PutLabel(3014) + PutLabel(
								903) + "/" + PutLabel(3018) + "/" + std::to_string(i + 1);
					medoutput << Label.c_str();
				}
				Label = "\t" + PutLabel(5001) + "/" + std::to_string(FNumeroCilindro) + PutLabel(3014) + PutLabel(903) + "/" + PutLabel(
							3018) + "/" + PutLabel(3020);
				medoutput << Label.c_str();
			}
			if(FResMediosCilindro.AFRMedio) {
				Label = "\t" + PutLabel(5001) + "/" + std::to_string(FNumeroCilindro) + "/" + PutLabel(4015) + PutLabel(901);
				medoutput << Label.c_str();
			}
			...
			if(FResMediosCilindro.Swirl) {
				Label = "\t" + PutLabel(5001) + "/" + std::to_string(FNumeroCilindro) + "/" + PutLabel(3021) + PutLabel(901);
				medoutput << Label.c_str();
			}
			if(FResMediosCilindro.RendVolumetrico) {
				Label = "\t" + PutLabel(5001) + "/" + std::to_string(FNumeroCilindro) + "/" + PutLabel(4011) + PutLabel(
							910) + "/" + PutLabel(3022);
				medoutput << Label.c_str();
			}
		}
	...
	try {
		...
		if(FNumVarIns > 0) {
			...
			if(FResInstantCilindro.Pressure) {
				Label = "\t" + PutLabel(5001) + "/" + std::to_string(FNumeroCilindro) + "/" + PutLabel(4006) + PutLabel(908);
			...
			if(FResInstantCilindro.MomentoAngularEsc) {
				for(int i = 0; i < FNumeroUnionesEsc; i++) {
					Label = "\t" + PutLabel(5001) + "/" + std::to_string(FNumeroCilindro) + "/" + PutLabel(4013) + PutLabel(
			...
			if(FResInstantCilindro.GastoEsc) {
				for(int i = 0; i < FNumeroUnionesEsc; i++) {
					Label = "\t" + PutLabel(5001) + "/" + std::to_string(FNumeroCilindro) + "/" + PutLabel(4008) + PutLabel(
			...
			if(FResInstantCilindro.MachEsc) {
				for(int i = 0; i < FNumeroUnionesEsc; i++) {
					Label = "\t" + PutLabel(5001) + "/" + std::to_string(FNumeroCilindro) + "/" + PutLabel(4014) + PutLabel(
								901) + "/" + PutLabel(3018) + "/" + std::to_string(i);
					insoutput << Label.c_str();
				}
			}
			...
			if(FResInstantCilindro.SeccionEfectivaEsc) {
				for(int i = 0; i < FNumeroUnionesEsc; i++) {
					Label = "\t" + PutLabel(5001) + "/" + std::to_string(FNumeroCilindro) + "/" + PutLabel(3029) + PutLabel(
			...
			if(FResInstantCilindro.Volumen) {
				Label = "\t" + PutLabel(5001) + "/" + std::to_string(FNumeroCilindro) + "/" + PutLabel(4003) + PutLabel(912);
				insoutput << Label.c_str();
			}
			if(FResInstantCilindro.CoeficienteWoschni) {
				Label = "\t" + PutLabel(5001) + "/" + std::to_string(FNumeroCilindro) + "/" + PutLabel(4015) + PutLabel(911);
				insoutput << Label.c_str();
			}
			...
			if(FResInstantCilindro.FQL) {
				Label = "\t" + PutLabel(5001) + "/" + std::to_string(FNumeroCilindro) + "/" + PutLabel(4018) + PutLabel(901);
				insoutput << Label.c_str();
			}
			...
			if(FResInstantCilindro.ParInstantaneo) {
				Label = "\t" + PutLabel(5001) + "/" + std::to_string(FNumeroCilindro) + "/" + PutLabel(4016) + PutLabel(917);
				insoutput << Label.c_str();
			}
			...
			if(FResInstantCilindro.FraccionMasica) {
				for(int i = 0; i < FMotor->getSpeciesNumber() - FIntEGR; i++) {
					Label = "\t" + PutLabel(5001) + "/" + std::to_string(FNumeroCilindro) + "/" + PutLabel(4023) + PutLabel(
								901) + "/" + DatosEspecies[i].Nombre;
					insoutput << Label.c_str();
				}
			}
			if(FResInstantCilindro.Gamma) {
				Label = "\t" + PutLabel(5001) + "/" + std::to_string(FNumeroCilindro) + "/" + PutLabel(4017) + PutLabel(901);
				insoutput << Label.c_str();
			}
	...
	try {
		...
		if(FMotor->getGeometria().CoefDeformaciones != 0) {
			double aux = FMotor->getGeometria().CoefDeformaciones / FMotor->getGeometria().ModuloElasticidad * pow(
							 FMotor->getGeometria().Diametro / FMotor->getGeometria().DiametroBulon, 2.)
		...
		if(FMotor->getSpeciesModel() == nmCalculoCompleto) {
			RAtmosfera = FMotor->GetComposicionAtmosfera(0) * __R::O2 + FMotor->GetComposicionAtmosfera(2) * __R::H2O
						 + (FMotor->GetComposicionAtmosfera(7) - 0.01292 * (1 - FMotor->GetComposicionAtmosfera(
									 2))) * __R::N2 + FMotor->GetComposicionAtmosfera(1) * __R::CO2
