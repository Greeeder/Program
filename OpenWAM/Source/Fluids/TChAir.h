 ...
 * \class	TChAir
 *
 * \brief	Chemical component: Air.
 *
 * \author	F.J. Arnau (farnau@mot.upv.es)
 * \date	05/12/2015
 */

class TChAir: public TChemicalComponent {
  ...
  public:
	...
	/*!
	 * \fn	TChAir(std::string nombre, double RU, double PMA);
	 *
	 * \brief	Constructor.
	 *
	 * \author	F.J. Arnau (farnau@mot.upv.es)
	...
	TChAir(std::string nombre, double RU, double PMA);
	...
	/*!
	 * \fn	virtual double FunVisc(double T)
	 *
