 ...
 * \class	TChOil
 *
 * \brief	Chemical component: Oil.
 *
 * \author	F.J. Arnau (farnau@mot.upv.es)
 * \date	29/01/2016
 */

class TChOil: public TChemicalComponent {
  ...
  public:
	...
	/*!
	 * \fn	TChOil(std::string nombre, double RU, double PMA);
	 *
	 * \brief	Constructor.
	 *
	 * \author	F.J. Arnau (farnau@mot.upv.es)
	...
	TChOil(std::string nombre, double RU, double PMA);
