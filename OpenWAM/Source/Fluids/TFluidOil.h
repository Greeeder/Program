 ...
 *
 * @section DESCRIPTION
 * The TFluidOil class is used for fluids composed only by oil.
 *
...
#ifndef __TFLUIDOIL_H
#define __TFLUIDOIL_H

/*!
 * \class	TFluidOil
 *
 * \brief	Fluid composed by oil.
 *
 * \author	F.J. Arnau (farnau@mot.upv.es)
 * \date	05/12/2015
 */

class TFluidOil : public TFluid {

  private:

	TComponentArray_obj comp;	//!< The array with the chemical components (only oil)
