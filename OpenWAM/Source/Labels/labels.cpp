...
void init_labels() {
	...
	labels[4030] = "Lift";
	labels[4031] = "Specific_Heat_Capacity_At_Constant_Pressure";
	labels[4032] = "Specific_Heat_Capacity_At_Constant_Volume";
	labels[4033] = "Gas_Constant";
	...
	labels[1833] = "Shape_factor_";
	labels[1834] = "Wall_soot_mass_";
	labels[1835] = "Layer_soot_mass_";
	labels[1836] = "CV_soot_mass_";
	labels[1837] = "Brownian_efficiency_";
	labels[1838] = "Interception_efficiency_";
	labels[1839] = "Inertial_efficiency_";
	labels[1840] = "PL_efficiency_";
	labels[1841] = "k_wall_clean_";
	labels[1842] = "k_wall_loaded_";
	labels[1843] = "Init_Soot_thickness_";
	labels[1844] = "k_soot_init_";
	labels[1845] = "k_soot_dep_";
	labels[1846] = "Dep_layer_soot_mass_";
	...
	labels[2833] = "Shape_factor_";
	labels[2834] = "Wall_soot_mass_";
	labels[2835] = "Layer_soot_mass_";
	labels[2836] = "CV_soot_mass_";
	labels[2837] = "Brownian_efficiency_";
	labels[2838] = "Interception_efficiency_";
	labels[2839] = "Inertial_efficiency_";
	labels[2840] = "PL_efficiency_";
	labels[2841] = "k_wall_clean_";
	labels[2842] = "k_wall_loaded_";
	labels[2843] = "Init_Soot_thickness_";
	labels[2844] = "k_soot_init_";
	labels[2845] = "k_soot_dep_";
	labels[2846] = "Dep_layer_soot_mass_";
}
