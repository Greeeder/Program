...
void TVenturi::CabeceraResultadosInstantVenturi(stringstream& insoutput) {
	try {
		...
		if(FResInstantVenturi.PresionEntrada) {
			Label = "\t" + PutLabel(5006) + "/" + std::to_string(FNumeroVenturi) + "/" + PutLabel(4006) + PutLabel(
						908) + "/" + PutLabel(3047);
		...
		if(FResInstantVenturi.MachEntrada) {
			Label = "\t" + PutLabel(5006) + "/" + std::to_string(FNumeroVenturi) + "/" + PutLabel(4014) + PutLabel(
						901) + "/" + PutLabel(3047);
			insoutput << Label.c_str();
		}
		...
		if(FResInstantVenturi.VelEntrada) {
			Label = "\t" + PutLabel(5006) + "/" + std::to_string(FNumeroVenturi) + "/" + PutLabel(4007) + PutLabel(
						909) + "/" + PutLabel(3047);
			insoutput << Label.c_str();
		}
		...
		if(FResInstantVenturi.GastoEntrada) {
			Label = "\t" + PutLabel(5006) + "/" + std::to_string(FNumeroVenturi) + "/" + PutLabel(4008) + PutLabel(
						904) + "/" + PutLabel(3047);
			insoutput << Label.c_str();
		}
