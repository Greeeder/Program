...
enum nmRePrmu {
	nmReMassTur = 0, nmReMassCom = 1, nmReMassOil = 2, nmReShaft = 3, nmPrTur = 4, nmPrCom = 5, nmPrOil = 6, nmmuG_T = 7, nmmuA_T = 8, nmmuO_T = 10, nmmuW_T = 11, nmmuG_H1 = 12, nmmuA_H1 = 13, nmmuO_H1 = 15, nmmuW_H1 = 16, nmmuG_H2 = 17, nmmuA_H2 = 18, nmmuO_H2 = 19, nmmuW_H2 = 20, nmmuG_H3 = 21, nmmuA_H3 = 22, nmmuO_H3 = 23, nmmuW_H3 = 24, nmmuG_C = 25, nmmuA_C = 26, nmmuO_C = 27, nmmuW_C = 28, nmReWater = 29, nmPrWater = 30, nmReMassCom2 = 31, nmPrCom2 = 32, nmReOilH1 = 33, nmReOilH2 = 34, nmReOilH3 = 35, nmPrOilH1 = 36, nmPrOilH2 = 37, nmPrOilH3 = 38
...
class TTC_HTM {
  ...
  public:
	...
	void TurbochargerData(double DShaft, double HD, double Doil, double DWater, double DT, double LT, double DC, double LC,
						  double DH, double LH);

	void TurbochargerWorkingPoint(double RTC, double MechEff, double O_MassFlow, double O_IT, double O_IP, double W_IT,
								  double W_MassFlow);

	void CompressorData(double PREF, double TREF, double TMAP_K, double Din, double Dout);

	void CompressorWorkingPoint(double C_Humidity, double C_MassFlow, double C_IT_C, double C_IP, double C_PR, double EFF);

	void TurbineData(double PREF, double TREF, double TMAP_K, double Din, double Dout);
	...
	double CorrectCompressorMap(double m, double cr, double eff, double TinC, double TinT, double Rtc, double mt = 0);

	double CorrectTurbineMap(double m, double er, double eff, double TinC, double TinT, double Rtc, double mc = 0);
