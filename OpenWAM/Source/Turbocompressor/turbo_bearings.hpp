#ifndef TURBO_BEARINGS2_HPP
#define TURBO_BEARINGS2_HPP
...
class TurboBearings {
  ...
  public:
	...
	TurboBearings(TFluid *Oil, double L_jb, double R_jb, double h_jb, double k_jb, double k_A_c, double k_A_t, double A_c,
